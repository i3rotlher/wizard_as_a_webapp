<template>
    ...
    <div class="row justify-content-end">
        <button type="button" class="btn btn-secondary" id="howToPlayBtn" data-toggle="tooltip" data-placement="top" title="How To Play ?">
    ...
    <div class="row" id="playGameContainer">
      ...
      <div class="col-12" style="text-align: center;">
        <button type="button" class="btn btn-secondary" id="playWizard" data-toggle="tooltip" data-placement="top" title="Play the Game">
    ...
    <div id="loadGameContainer" style="display: none" class="row">
      <div class="col-12">
        <h2 id="loadGame" class="loading"> A Master Wizard is creating your Game <span>.</span><span>.</span><span>.</span></h2>
        <div class="col-sm"><img style="margin: auto; display: flex;" src="https://media.tenor.com/tDvhq0ZebWMAAAAi/wizard-rainbow.gif"></div>
      </div>
    </div>
  </div>
